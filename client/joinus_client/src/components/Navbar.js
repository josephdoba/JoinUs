    ...
    <div>
      <nav className="nav" id={props.theme}>
        <main className="main-navbar">
          ...
          {props.success ? (
            <div>
              <div className="logged-in">Logged in as: {props.user.email}</div>{" "}
              ...
              <div className="dropdown" data-dropdown>
                ...
                <div className="dropdown-menu" id={props.theme}>
                  <form onSubmit={handleSubmit}>
                    <label htmlFor="email" id={props.theme}>
                    ...
                    ></input>
                    <label htmlFor="password" id={props.theme}>
                      Enter your password:
                    </label>
                    <input
                      type="password"
          ...
          {props.success === false ? (
            <div className="signup">
              <button className="but" id={props.theme}>
                Signup
              </button>
            </div>
          ) : null}
